    ...
    <>
      ...
      <div className="row gap-5">
        <div className="col-md-4 mb-5 mb-md-0">
          <img src="https://i.hizliresim.com/fgmodak.png" alt="Resim" className="img-fluid rounded" />
        </div>
        <div className="col-md-6 d-flex align-items-center">
          <div className="text-center ">
            <p className='fw-light  '>Beau Monde is a full-service hair salon and offers spa services including massage, facials, reiki treatments and myofascial release. We exclusively use and retail Redken and Pureology hair care and delicious Farmhouse Fresh skin care products.</p>
